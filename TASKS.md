...
- WP-32.2 `SECURITY.md` (responsible-disclosure policy, scope, 90-day timeline) + `docs/THREAT-MODEL.md` (5 trust boundaries + 10-row attack-surface matrix + 3-quarter roadmap).
- WP-32.3 Light audit pass mapped existing controls (SSRF, encryption, RLS, security_invoker, redactPayload, append-only audit) to threat-model rows. No code changes.
