...
- [~] **3.2 MCP gateway skeleton — Inspector-verified** (~45min) — code + in-process vitest landed (`8b8d7b8`). Pending: MCP Inspector check against local `pnpm dev` then deployed Vercel URL. Must green-light before 3.3.
